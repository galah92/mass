...
- **`assignment1_report.md`** (8KB, 106 lines) - Technical report with:
...
2. **`assignment1_report.pdf`** ⚠️ Needs Conversion
   - Source: `assignment1_report.md` (8KB, 106 lines)
...
├── assignment1_report.md       # Technical report (8KB, 106 lines)
